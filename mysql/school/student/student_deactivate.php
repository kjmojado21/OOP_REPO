<?php
    ...
    if(isset($_POST['deactivate'])){
        $protocol = $_POST['student_deactivate'];
        $protocols = array('DEACTIVATE', 'deactivate', 'Deactivate');

        if(in_array($protocol, $protocols)){
           $result =  deactivate_student($id);
           if($result === true){
...
<body>
    ...
    <div class="container mt-3">
        <div class="card border-danger">
            <h3 class="m-3 card-title text-danger">Deactivate Student</h3>
            <div class="card-body">
                <p class="lead">
                    Student Name: <?php echo $student_info['student_firstname']." ".$student_info['student_lastname']; ?>
                    <br>
                    Student Birthday: <?php echo $student_info['student_birthday']; ?>
                    <br>
                    
                    <form action="" method="post">
                        <div class="form-group">
                            <label for="">Are you sure you're going to deactivate this student? 
                            Type 'deactivate' to proceed, 'cancel' to cancel</label>
                            <input type="text" name="student_deactivate" id="" class="form-control">
                        </div>
