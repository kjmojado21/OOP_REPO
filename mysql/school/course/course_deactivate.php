<?php
    ...
    if(isset($_POST['deactivate'])){
        $protocol = $_POST['course_deactivate'];
        $protocols = array('DEACTIVATE', 'deactivate', 'Deactivate');

        if(in_array($protocol, $protocols)){
           $result =  deactivate_course($id);
           if($result === true){
...
<body>
    ...
    <div class="container mt-3">
        <div class="card border-danger">
            <h3 class="m-3 card-title text-danger">Deactivate Course</h3>
            <div class="card-body">
                <p class="lead">
                    Course Name: <?php echo $course_info['course_name']; ?>
                    <br>
                    Course Description: <p><?php echo $course_info['course_description']; ?></p>
                    <br>
                    
                    <form action="" method="post">
                        <div class="form-group">
                            <label for="">Are you sure you're going to deactivate this course? 
                            Type 'deactivate' to proceed, 'cancel' to cancel</label>
                            <input type="text" name="course_deactivate" id="" class="form-control">
                        </div>
