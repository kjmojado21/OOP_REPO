<?php
    ...
    function generate_ptag($limit){
        $local_string = null;
        for($i=0; $i < $limit; $i++){
            $local_string .= "<p class='lead'> This is generated by PHP</p> <br>";
        }
        return $local_string;
    }
        ...
        <div class="container">
            <form action="" method="post">
                <div class="form-group">
                    <label for="">Enter number of Paragraph</label>
